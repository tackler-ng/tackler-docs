...
See CLI option xref:reference:command-line.adoc#exports[--export]
and xref:reference:tackler-toml.adoc#export[export.targets setting]
in the tackler.toml for how to activate equity export.

== Equity export configuration

For configuration options, see
xref:reference:tackler-toml.adoc#export-equity[equity section]
in the tackler.toml.
