...
in the tackler.toml for how to activate the balance report.

For configuration options, see
xref:reference:tackler-toml.adoc#report-balance[report.balance section]
in the tackler.toml.
...
tackler's configuration file xref:reference:tackler-toml.adoc#report-balance[tackler.toml].
...
See xref:reference:tackler-toml.adoc#report-balance[tackler.toml] and `report.balance.*` for full
