...
in the tackler.toml for how to activate the balance group report.

For configuration options, see
xref:reference:tackler-toml.adoc#report-balance-group[report.balance-group section]
in the tackler.toml.
...
tackler's configuration file xref:reference:tackler-toml.adoc#report-balance-group[tackler.toml].
...
See xref:reference:tackler-toml.adoc#report-balance-group[tackler.toml] and `report.balance-group.*` for full
