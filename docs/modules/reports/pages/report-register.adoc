...
Register report is a report with a running total of transactions
for selected accounts.

See CLI option xref:reference:command-line.adoc#reports[--reports]
and xref:reference:tackler-toml.adoc#report[report.targets setting]
in the tackler.toml for how to activate the register report.

For configuration options, see
xref:reference:tackler-toml.adoc#report-register[report.register section]
in the tackler.toml.
...
See xref:reference:tackler-toml.adoc#report-register[tackler.toml] and `report.register.*` for full
...
See 'timezone', 'report-timezone' options in xref:reference:tackler-toml.adoc#report-register[tackler.toml].
