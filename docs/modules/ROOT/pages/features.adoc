...
* Tackler has excellent performance - it can process xref:usage:performance.adoc[700_000 txn/s] on modern laptop

* Tackler is written in link:https://www.rust-lang.org/[Rust] and it's xref:reliability.adoc[well tested]
...
* Audit trail for xref:usage:auditing.adoc[Accounting Auditing]
