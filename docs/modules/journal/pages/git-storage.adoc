...
See xref:journal:sharding.adoc[Transaction data sharding] for ideas how to store data inside git repository. It is
...
Then you have to configure git storage, see xref:reference:tackler-conf.adoc[tackler.conf] for full explanation, but it could be as simple as:
