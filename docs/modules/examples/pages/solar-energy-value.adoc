...
as it can easily process link:/news/2025/01/21/250_000_txns/[hundreds of thousands] transactions.
...
The full solar energy value example is located under link:https://github.com/tackler-ng/tackler/tree/main/examples[tackler example] folder, and it's executed as part of the Tackler's CI/CD jobs.
