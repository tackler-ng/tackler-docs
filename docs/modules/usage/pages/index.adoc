...
If your installation follows xref:ROOT:installation.adoc#layout[recommended structure],
...
(If you created minimal setup based on xref:ROOT:installation.adoc[Installation Manual])
...
with xref:reference:tackler-conf.adoc[configured] suffix will be used as journal files.
...
For full list of available filters and their syntax, see xref:usage:txn-filters.adoc[Transaction Filters]
document.
...
with xref:usage:index.adoc#txn-filters-shell[shell scripts].
...
See xref:usage:txn-filters.adoc[Transaction Filters] for list of all available filters and their syntax.
...
Produced reports can be selected either by xref:reference:tackler-conf.adoc[configuration] or CLI options:
...
Produced exports can be selected either by xref:reference:tackler-conf.adoc[configuration] or CLI options:


`--reporting.exports export1 export2`::

valid options are xref:reports:export-identity.adoc[`identity`]


===== Selecting report formats

Report formats can be selected either by xref:reference:tackler-conf.adoc[configuration] or CLI options:
...
See xref:reference:tackler-conf.adoc[tackler.conf] full documentation.
...
[NOTE]
====
See xref:reports:report-balance-group.adoc[Balance Group]
...
GroupBy is set by xref:reference:tackler-conf.adoc[configuration (tackler.conf)].
...
* `<output>.bal.txt`: xref:reports:report-balance.adoc[Balance report]
* `<output>.balgrp.txt`: xref:reports:report-balance-group.adoc[Balance Groups report]
* `<output>.reg.txt`: xref:reports:report-register.adoc[Registry report]
...
See document xref:usage:auditing.adoc[Accounting Auditing and Assurance] for information how Tackler reports could support
