...
:page-last_modified_at: 2026-07-12 00:00:00 Z
...
Txn external id filter selects transactions which txn ext-id matches specified {url-regex}[regular expression].
