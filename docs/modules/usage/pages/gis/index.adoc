...
See xref:usage:gis/txn-geo-location.adoc[Transaction Geo Location] for how to store geographic location with
accounting transactions, and xref:usage:gis/txn-geo-filters.adoc[Transaction Geo Filters] how to select transactions based
